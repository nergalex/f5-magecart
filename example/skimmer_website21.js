window["data_leak_label_email"] = ["input[id*='edit-name']", "input[name*='name']", "input[type*='email']"]
window["data_leak_label_password"] = ["input[id*='edit-pass']", "input[name*='pass']", "input[type*='password']"]
window["data_leak_label_submit_button"] = ["input[id*='edit-submit']"]
