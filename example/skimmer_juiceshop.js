window["data_leak_label_username"] = ["input[id*='email']", "input[name*='email']"]
window["data_leak_label_password"] = ["input[id*='password']", "input[name*='password']", "input[type*='password']"]
