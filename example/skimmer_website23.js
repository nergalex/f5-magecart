window["data_leak_label_email"] = ["input[id*='mat-input-0']", "input[formcontrolname*='loginId']"]
window["data_leak_label_password"] = ["input[id*='mat-input-1']", "input[formcontrolname*='password']", "input[type*='password']"]
window["data_leak_label_submit_button"] = ["button.mat-raised-button"]
